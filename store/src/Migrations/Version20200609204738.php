...
final class Version20200609204738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_products (id INT NOT NULL, created_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, sku VARCHAR(255) NOT NULL, price_price NUMERIC(7, 2) NOT NULL, price_old_price NUMERIC(7, 2) NOT NULL, warehouse INT NOT NULL, weight DOUBLE PRECISION NOT NULL, description TEXT DEFAULT NULL, is_deleted BOOLEAN NOT NULL DEFAULT (false), sort INT NOT NULL, meta_title VARCHAR(255) DEFAULT NULL, meta_keywords TEXT DEFAULT NULL, meta_description TEXT DEFAULT NULL, PRIMARY KEY(id))');
